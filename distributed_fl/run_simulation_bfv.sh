#!/bin/bash
#SBATCH --job-name=fl_bfv_simulation # [MODIFIED] New job name
#SBATCH --output=/homes/01/sxbhattarai/sec-agg/logs/bfv_simulation_%j.out # [MODIFIED] New output log file
#SBATCH --error=/homes/01/sxbhattarai/sec-agg/logs/bfv_simulation_%j.err   # [MODIFIED] New error log file
...
/homes/01/sxbhattarai/miniconda3/envs/flwr_env_py310/bin/python "$PROJECT_HOME/main_bfv.py"
